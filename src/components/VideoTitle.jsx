const VideoTitle = ({ title, overview }) => {
  return (
    <div className="w-screen aspect-video flex flex-col items-start justify-center h-full pt-20 p-6 bg-gradient-to-r from-black rounded-lg shadow-lg absolute">
